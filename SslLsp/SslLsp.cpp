					  ...
					  LPWSPPROC_TABLE lpProcTable)
{
	...
	try
	{
		if(g_LspStartupCount++ == 0)
		{
			...
			{
				OutputDebugString(L"<SslLsp::WSPStartup()> WARNING: WaitForSingleObject(g_ComCallThreadCompletionEvent) Failed.\n");
			}
	...
	catch(const wchar_t *e)
	{
		...
		OutputDebugString(L"<SslLsp::WSPStartup()> Fatal Error: ");
		OutputDebugString(e);
		OutputDebugString(L"\n");
	}
	...
	if(--g_LspStartupCount == 0)
	{
		if(g_ComCallThreadExitEvent != NULL)
		{
			...
			if(g_ComCallThread != NULL)
			{
				...
				{
					OutputDebugString(L"<SslLsp::WSPCleanup()> WARNING: WaitForSingleObject(g_ComCallThread) Failed.\n");
				}
						...
						LPINT lpErrno)
{
	...
	{
		OutputDebugString(L"<SslLsp::WSPAccept()> WARNING: Returning WSAENOTSOCK.\n");
	...
	{
		OutputDebugString(L"<SslLsp::WSPAccept()> Fatal Error: ");
		OutputDebugString(e);
		OutputDebugString(L"\n");
	}
...
int WSPAPI WSPCloseSocket(SOCKET s, LPINT lpErrno)
{
	...
	if(socketContext == NULL)
	{
		OutputDebugString(L"<SslLsp::WSPCloseSocket()> WARNING: Returning WSAENOTSOCK.\n");
	...
	{
		OutputDebugString(L"<SslLsp::WSPCloseSocket()> Fatal Error: ");
		OutputDebugString(e);
		OutputDebugString(L"\n");
	}
					  ...
					  LPINT lpErrno)
{
	...
	{
		OutputDebugString(L"<SslLsp::WSPConnect()> WARNING: namelen != sizeof(sockaddr_in).\n");
	}
	else
	{
	...
	if(socketContext == NULL)
	{
		OutputDebugString(L"<SslLsp::WSPConnect()> WARNING: Returning WSAENOTSOCK.\n");
						 ...
						 LPOVERLAPPED lpOverlapped)
{
	...
	if(socketContext == NULL)
	{
		OutputDebugString(L"<SslLsp::ExtConnectEx()> WARNING: Returning WSAENOTSOCK.\n");
		return FALSE;
	}
	...
	if(socketContext->Provider->NextProcTableEx.lpfnConnectEx == NULL)
	{
		...
		{
			OutputDebugString(L"<SslLsp::ExtConnectEx()> WARNING: WSAIoctl(SIO_GET_EXTENSION_FUNCTION) Failed\n");
			return FALSE;
		}
	}
						...
						LPINT lpErrno)
{
	...
	if(lpProvider == NULL)
	{
		OutputDebugString(L"<SslLsp::WSPSocket()> WARNING: No lpProvider.\n");
		return socketResult;
	}
	...
	{
		OutputDebugString(L"<SslLsp::WSPSocket()> Fatal Error: ");
		OutputDebugString(e);
		OutputDebugString(L"\n");
	}
...
int WSPAPI WSPGetSockOpt(SOCKET s, int level, int optname, char* optval, LPINT optlen, LPINT lpErrno)
{
	...
	if(socketContext == NULL)
	{
		OutputDebugString(L"<SslLsp::WSPGetSockOpt()> WARNING: Returning WSAENOTSOCK.\n");
		*lpErrno = WSAENOTSOCK;
		return SOCKET_ERROR;
	}
					...
					LPINT lpErrno)
{
	...
	if(socketContext == NULL)
	{
		OutputDebugString(L"<SslLsp::WSPIoctl()> WARNING: Returning WSAENOTSOCK.\n");
		*lpErrno = WSAENOTSOCK;
		return SOCKET_ERROR;
	}
	...
	if(dwIoControlCode == SIO_GET_EXTENSION_FUNCTION_POINTER)
	{
		...
		if(RtlEqualMemory(lpvInBuffer, &ConnectExGuid, sizeof(GUID)))
		{
			...
			{
				OutputDebugString(L"<SslLsp::WSPIoctl()> WARNING: Returning WSAEFAULT.\n");
				   ...
				   LPINT lpErrno)
{
	...
	{
		OutputDebugString(L"<SslLsp::WSPRecv()> WARNING: lpOverlapped or lpCompletionRoutine Specified.\n");
	}
	...
	if(socketContext == NULL)
	{
		OutputDebugString(L"<SslLsp::WSPRecv()> WARNING: Returning WSAENOTSOCK.\n");
		*lpErrno = WSAENOTSOCK;
		return SOCKET_ERROR;
	}
					   ...
					   LPINT lpErrno)
{
	...
	{
		OutputDebugString(L"<SslLsp::WSPRecvFrom()> WARNING: lpFromlen != sizeof(sockaddr_in).\n");
	}
	else
	{
	...
	if(socketContext == NULL)
	{
		OutputDebugString(L"<SslLsp::WSPRecvFrom()> WARNING: Returning WSAENOTSOCK.\n");
				   ...
				   LPINT lpErrno)
{
	if((lpOverlapped != NULL) || (lpCompletionRoutine != NULL))
	{
		OutputDebugString(L"<SslLsp::WSPSend()> WARNING: lpOverlapped or lpCompletionRoutine Specified.\n");
	}
	...
	if(socketContext == NULL)
	{
		OutputDebugString(L"<SslLsp::WSPSend()> WARNING: Returning WSAENOTSOCK.\n");
					 ...
					 LPINT lpErrno)
{
	...
	{
		OutputDebugString(L"<SslLsp::WSPSendTo()> - Error: iTolen != sizeof(sockaddr_in).\n");
	}
	else
	{
	...
	if(socketContext == NULL)
	{
		OutputDebugString(L"<SslLsp::WSPSendTo()> WARNING: Returning WSAENOTSOCK.\n");
...
DWORD WINAPI ComCallThreadProc(LPVOID lpParameter)
{
		...
		while(WaitForSingleObject(g_ComCallThreadExitEvent, 0) != WAIT_OBJECT_0)
		{
										  ...
										  reinterpret_cast<LPVOID *>(&pClassFactoryUnknown))))
			{
																  ...
																  reinterpret_cast<LPVOID *>(&pClassFactory))))
				{
															   ...
															   reinterpret_cast<LPVOID *>(&pSslPyFilterUnknown))))
					{
						...
						{
							OutputDebugString(L"<SslLsp::ComCallThreadProc()> WARNING: pSslPyFilterUnknown->QueryInterface() Failed.\n");
							pSslPyFilter = NULL;
						}
					...
					{
						OutputDebugString(L"<SslLsp::ComCallThreadProc()> WARNING: pClassFactory->CreateInstance() Failed.\n");
					}
				...
				{
					OutputDebugString(L"<SslLsp::ComCallThreadProc()> WARNING: pClassFactoryUnknown->QueryInterface() Failed.\n");
				}
			...
			else
			{
				...
				while(true)
				{
					...
					{
						case ReceiveFilter:
							g_ComCallParameter->hResult = pSslPyFilter->RecvFilter(GetCurrentProcessId(),
						...
						case SendFilter:
							g_ComCallParameter->hResult = pSslPyFilter->SendFilter(GetCurrentProcessId(),
																				   g_ComCallParameter->Thread,
																				   g_ComCallParameter->Socket,
																				   g_ComCallParameter->InputBuffer,
																				   g_ComCallParameter->OutputBuffer);
						...
						default:
							OutputDebugString(L"<SslLsp::ComCallThreadProc()> WARNING: g_ComCallParameter->Type Unknown.\n");
							break;
					}
					...
					if(g_ComCallParameter->hResult == HRESULT_FROM_WIN32(RPC_S_SERVER_UNAVAILABLE))
					{
						...
						OutputDebugString(L"<SslLsp::ComCallThreadProc()> WARNING: pSslPyFilter Call Returned RPC_S_SERVER_UNAVAILABLE.\n");
						SetEvent(g_ComCallThreadCompletionEvent);
						break;
					}
					else
	...
	{
		OutputDebugString(L"<SslLsp::ComCallThreadProc()> WARNING: CoInitializeEx() Failed.\n");
	}
